    ...
    public:
        ...
        double CalcPE(int frame_i, Trajectory &trj, coordinates &rand_xyz, cubicbox_m256 &box, double vol)
        {
            ...
            for (; atom_i < this->n-8; atom_i+=8)
            {
                ...
                ri6 = _mm256_and_ps(mask, _mm256_rcp_ps(_mm256_mul_ps(_mm256_mul_ps(r2_8, r2_8), r2_8)));
                pe_sum = _mm256_and_ps(mask, _mm256_add_ps(_mm256_mul_ps(ri6, _mm256_sub_ps(_mm256_mul_ps(c12_8, ri6), c6_8)), pe_sum));
            }
